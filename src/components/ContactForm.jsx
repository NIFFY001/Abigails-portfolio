...
const ContactForm = () => {
  ...
  const handleSendEmail = () => {
    ...
    window.location.href = `mailto:abigailalabi0@gmail.com?subject=${encodeURIComponent(
      subject
  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      <form>
        ...
        <button
          type="button"
          className="bg-gradient-to-r from-[#B16CEA] via-[#FF7460] to-[#FFA84B] text-white font-bold py-2 px-4 rounded w-full"
